...
latex_documents = [
    (master_doc, 'gotran.tex', 'gotran Documentation',
     'Henrik', 'manual'),
]
...
man_pages = [
    (master_doc, 'gotran', 'gotran Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gotran', 'gotran Documentation',
     author, 'gotran', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {'python': ('https://docs.python.org/3', None),
                       'sympy': ('https://docs.sympy.org/0.7.6.1', None)}
