...
author = "Joahan Hake, Henrik Finsberg, Kristian G. Hustad"
...
man_pages = [(master_doc, "gotran", "gotran Documentation", [author], 1)]
...
intersphinx_mapping = {
    ...
    "sympy": ("https://docs.sympy.org/1.1.1", None),
}
