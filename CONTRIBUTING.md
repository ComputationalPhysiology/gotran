...
To get an overview of the project, read the [documentation](https://computationalphysiology.github.io/gotran/). Here are some resources to help you get started with open source contributions:
